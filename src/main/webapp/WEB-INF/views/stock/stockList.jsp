...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/stock/stockList.js"></script>
...
<body>
	<div id="wrapper">
        ...
        <div id="page-wrapper">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover" id="stockList">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>제품명</th>
	        ...
	        <div>
	        	<div class="btnArea">
			        <button type="button" class="btn btn-primary" id="btnInProd">입고</button>
			        <button type="button" class="btn btn-primary" id="btnOutProd">출고</button>
		        </div>
	            <span>* 재고 수정을 하고 싶은 제품을 더블클릭해 주세요.</span>
	            <div class="panel panel-default">
	                <div class="panel-heading">재고 수정 리스트 </div>
	                <!-- /.panel-heading -->
	                <div class="panel-body" id="prodModifyWrap">
	                    <span class="alert alert-info prodModyBox">
	                        <button type="button" class="close">×</button>
	                       	<span class="prodNm">CCTV2</span>
	                    </span>
	                </div>
	                <!-- .panel-body -->
	            </div>
